...
class OfertadorTest {
	...
	void comprobarOrdenTest() {
		try {
			...
			ofertasEsperadas.add(new Atraccion("atraccion2", 5, 5, "tipo 1", 1)); // Esta deberia ser la primera
																					// atraccion en aparecer
	...
	void noOfertaAtraccionQueNoPuedeComprar() throws AtraccionExcepcion, UsuarioExcepcion, OfertadorExcepcion {
		...
		// Esperamos las primeras 2 atracciones, ya que para las demas se queda sin
		// monedas y tiempo
		ofertasEsperadas.add(atraccion1);
		ofertasEsperadas.add(atraccion2);
